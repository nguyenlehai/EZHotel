        ...
        <form action="" method="get">
          ...
          <c:if test="${sessionScope.login == 'true'}">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                <button style="padding-top: 15px" type="button" class="btn btn-link" onclick="location.href='/logout'">
                  Logout
                </button>
              </li>
            </ul>
          ...
          <c:if test="${sessionScope.login != 'true'}">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                <button style="margin-top: 8px" type="button" class="btn btn-primary" onclick="location.href='/login'">
                  Login
                </button>
              </li>
            </ul>
